...
import com.brightcoding.app.ws.reponses.ErrorMessages;
import com.brightcoding.app.ws.reponses.UserResponse;
...
//			 BeanUtils.copyProperties(userDto, user);
	...
	public ResponseEntity<UserResponse> createUser(@RequestBody @Valid UserRequest userRequest) throws Exception {
		...
		if (userRequest.getFirstName().isEmpty())
			throw new UserException(ErrorMessages.MISSING_REQUIERD_FIELD.getErrorMessage());
