...
public class AddressServiceImpl implements AddressService  {
	...
	public AddressDto updateAddress(String id, AddressDto addressDto) {
		...
		AddressEntity updateAddress = addressRepository.save(addressEntity);
		
		ModelMapper modelMapper = new ModelMapper();
		AddressDto update = modelMapper.map(updateAddress, AddressDto.class);
	...
	public AddressDto getAddress(String addressId) {
		...
		AddressDto addressesDto = modelMapper.map(addressEntity, AddressDto.class);
